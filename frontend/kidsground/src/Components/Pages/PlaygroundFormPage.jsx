        ...
        <div id="add-playground">
            ...
            <h2 style={{textAlign:"center"}}>Добави площадка</h2>
                <div className="question" id="name-question">
                    ...
                    <br/>
                    <input id="playground-name" type="text" className="text-input" placeholder="Име на площадката, ако има такова." name="name"/>
                </div>
                ...
                <div className="question" id="age-group-question">
                    ...
                    <div className="choice">
                        <input type="radio" className="playground-input playground-input-radio" id="under-1" name="age-group" value="under-1"/>
                        <label for="under-1">Под 1г.</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input playground-input-radio" id="1-3years" name="age-group" value="1-3years"/>
                        <label for="1-3years">1-3г.</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input playground-input-radio" id="3-6years" name="age-group" value="3-6years"/>
                        <label for="3-6years">3-6г.</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input playground-input-radio" id="6-12years" name="age-group" value="6-12years"/>
                        <label for="6-12years">6-12г.</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input playground-input-radio" id="other-years" name="age-group" value="other-years"/>
                ...
                <div className="question" id="location-question">
                    ...
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input playground-input-radio" id="boulevard" name="boulevard" value="boulevard"/>
                        <label for="boulevard">До голям булевард</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input playground-input-radio" id="park" name="park" value="park"/>
                        <label for="park">В парк или градинка</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input playground-input-radio" id="apartments" name="apartments" value="apartments"/>
                        <label for="apartments">В междублоково пространство</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input playground-input-radio" id="other-place" name="other-place" value="other-place"/>
                ...
                <div className="question" id="shade-question">
                    ...
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input playground-input-radio" id="tree-shade" name="tree-shade" value="tree-shade"/>
                        <label for="tree-shade">Да, естествена сянка от дървета</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input playground-input-radio" id="fake-shade" name="fake-shade" value="fake-shade"/>
                        <label for="fake-shade">Да, изкуствена сянка от съоръжение</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input playground-input-radio" id="no-shade" name="no-shade" value="no-shade"/>
                ...
                <div className="question" id="transport-question">
                    ...
                    <br/>
                    <div className="choice">
                        <input type="checkbox" className="playground-input" id="free-parking" name="location" value="free-parking"/>
                ...
                <div className="question" id="fence-question">
                    ...
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input" id="yes" name="yes" value="yes"/>
                        <label for="yes">Да</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input" id="no" name="no" value="no"/>
                ...
                <div className="question" id="floor-question">
                    ...
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input" id="asphalt" name="asphalt" value="asphalt"/>
                        <label for="asphalt">Асфалт / бетонни плочи</label>
                    </div>
                    <br/>
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input" id="grass" name="grass" value="grass"/>
                        <label for="asphalt">Тревна настилка</label>
                    </div>
                    <br/>
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input" id="rubber" name="rubber" value="rubber"/>
                        <label for="asphalt">Ударопоглъщаща гумена настилка</label>
                    </div>
                    <br/>
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input" id="mulch" name="mulch" value="mulch"/>
                        <label for="asphalt">Стърготини (мулч)</label>
                    </div>
                    <br/>
                    <br/>
                    <div className="choice">
                        <input type="radio" className="playground-input" id="dirt" name="dirt" value="dirt"/>
                ...
                <div className="question" id="swings-question">
                    ...
                    <br/>
                    <div className="choice">
                        <input type="checkbox" className="playground-input" id="combined" name="combined" value="combined"/>
                        <label for="combined">Комбинирано съоражение</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="checkbox" className="playground-input" id="slide" name="slide" value="slide"/>
                        <label for="slide">Пързалка</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="checkbox" className="playground-input" id="swing" name="swing" value="swing"/>
                        <label for="swing">Люлка</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="checkbox" className="playground-input" id="seesaw" name="seesaw" value="seesaw"/>
                        <label for="seesaw">Люлка-везна</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="checkbox" className="playground-input" id="spring-riders" name="spring-riders" value="spring-riders"/>
                        <label for="spring-riders">Пружинни клатушки</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="checkbox" className="playground-input" id="balance-beam" name="balance-beam" value="balance-beam"/>
                        <label for="balance-beam">Съоражение за катерене и баланс</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="checkbox" className="playground-input" id="climbing-wall" name="climbing-wall" value="climbing-wall"/>
                        <label for="climbing-wall">Стена за катерене</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="checkbox" className="playground-input" id="dynamic" name="dynamic" value="dynamic"/>
                        <label for="dynamic">Динамични съоражения за игра (батут, въжен "тролей")</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="checkbox" className="playground-input" id="accessible" name="accesible" value="accessible"/>
                        <label for="accessible">Съораженя, достъпни за деца с ограничени двигателни функции</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="checkbox" className="playground-input" id="house" name="house" value="house"/>
                        <label for="house">Детски къщичка и беседка</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="checkbox" className="playground-input" id="go-round" name="go-round" value="go-round"/>
                        <label for="go-round">Въртележка</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="checkbox" className="playground-input" id="tunnel" name="tunel" value="tunnel"/>
                        <label for="tunnel">Тунел</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="checkbox" className="playground-input" id="sandbox" name="sandbox" value="sandbox"/>
                        <label for="sandbox">Пясъчник и съоражения за игра с пясък</label>
                    </div>
                    <br/>
                    <div className="choice">
                        <input type="checkbox" className="playground-input" id="games" name="games" value="games"/>
                ...
                <div className="question" id="facilities-question">
                    <label className="form-label" for="facilities-question">9. Какъв е транспортният достъп?</label>
                    <br/>
                    <div className="choice">
                ...
                <br/>
                <textarea type="text" className="text-input" name="description" rows="10" cols="20"></textarea>
                </div>
                <div>
